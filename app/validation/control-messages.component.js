System.register(['@angular/core', '@angular/common', './validation.service'], function(exports_1, context_1) {
    "use strict";
                        ...
                        for (var propertyName in c.errors) {
                            ...
                            if (c.errors.hasOwnProperty(propertyName) && c.touched) {
                                ...
                                if (propertyName === 'minlength') {
                                    var reqLength = c.errors['minlength'].requiredLength;
                                    return validation_service_1.ValidationService.getValidatorErrorMessage(propertyName, reqLength);
                                }
                                else {
                                    return validation_service_1.ValidationService.getValidatorErrorMessage(propertyName, null);
                                }
                            }
                        }
                        return null;
